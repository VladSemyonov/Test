...
export const pageQuery = graphql`
  query InfrastructurePageQuery($locale: String!) {
    cmsApi {
      page(content: "Infrastructure_page", locale: $locale) {
        name
        type
        value
      }
      table(content: "infrastructure_page", locale: $locale) {
        slug
        properties {
          name
          type
...
interface InfrastructurePageProps extends PageProps {
  data: {
    cmsApi: {
...
const InfrastructurePage: FunctionComponent<InfrastructurePageProps> = ({
  data,
}) => {
